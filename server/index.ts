...
import { initSeedUsers, comparePassword, generateToken } from './auth.js';
import { startInventoryCron } from './inventory.js';
import { PORTS_CONFIG, logRbacEvent, ROLE_PERMISSIONS } from './rbac.js';
...
export async function startServer() {
  ...
  adminApp.use('/api/architecture', architectureRoutes);
  ...
  clientApp.use('/api/architecture', architectureRoutes);
